...
const initializeMina = async () => {
  ...
  sendButton.onclick = async () => {
    let sendResult = await window.mina
      .sendLegacyPayment({
  ...
  const vaildatorAddressInput = document.getElementById(
  ...
  stakingButton.onclick = async () => {
    let stakingResult = await window.mina
  ...
  signPartyButton.onclick = async () => {
    ...
    let partyResult = await window.mina
      .sendTransaction({
        transaction: zkBody,
        feePayer: {
  ...
  signVerifyButton.onclick = async () => {
    ...
    let messageVerifyResult = await window.mina
      .verifyMessage(verifyMessageBody)
      .catch((err) => err);
    verifyResult.innerHTML =
      messageVerifyResult.error?.message || messageVerifyResult;
  };
